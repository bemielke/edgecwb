 ...
 *
 * This Reftek templace for creating a DBConnectionTh database object.  It is not
 ...
 * @author  D.C. Ketchum
 */
public class ReftekPortable     //implements Comparator
{   // static ArrayList enumName;   // this need to be populated in makeReftek()
   ...
   */
  public ReftekPortable(ResultSet rs) throws SQLException {  //USER: add all data field here
    makeReftek(rs.getInt("ID"), rs.getString("station"), rs.getString("network"),
            ...
            rs.getString("comment"), rs.getInt("deploymentid")
   ...
   */
  public ReftekPortable(int inID, String loc   //USER: add fields, double lon
          ...
          int st3, double rt3, String ch3, String cp3, String lc3, String bnd3, String comment, int deployID   ) {
    makeReftek(inID, loc, net, sn, ip,netm, gate, st1, rt1, ch1, cp1, lc1,
            bnd1, st2, rt2, ch2, cp2, lc2, bnd2, st3, rt3, ch3, cp3, lc3, bnd3, comment, deployID       //, lon
    );
  }
  ...
  private void makeReftek(int inID, String loc,    //USER: add fields, double lon
          ...
          int st1, double rt1, String ch1, String cp1, String lc1, String bnd1,
          int st2, double rt2, String ch2, String cp2, String lc2, String bnd2,
          int st3, double rt3, String ch3, String cp3, String lc3, String bnd3, String cmt, int deployID
  ) {
    ...
    comment = cmt; deploymentID=deployID;

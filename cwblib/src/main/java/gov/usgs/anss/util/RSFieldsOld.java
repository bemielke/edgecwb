 ...
 * @version 1.00
 */
public final class RSFieldsOld extends Object {
   ...
   */
  public RSFieldsOld(int columnin, ResultSetMetaData md) {
    try {
      column = columnin;
  ...
  public String toStringDump() {
    return "col=" + column + " label=" + label + " name=" + name
            + " type=" + type + "/" + typeName + " prec.scale=" + precision + "/" + scale + " width=" + width + " table=" + table + " schema=" + schema;
  }

  /**
   * Convert the column represented by this RSFieldsOld to a string given a result set where this

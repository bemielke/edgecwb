 ...
 *
 * This ADAllow templace for creating a MySQL database object.  It is not
 * really needed by the ADAllowPanel which uses the DBObject system for
 ...
 *     of data.  
 *<br>
 * The ADAllow should be replaced with capitalized version (class name) for the
 * file.  adAllow should be replaced with the lower case version (for variables).
 *
 * Both the constructors use the "makeADAllow(list of data args) to set the
 ...
 * @author  D.C. Ketchum
 */
public class ADAllow     //implements Comparator
{   // static ArrayList enumName;   // this need to be populated in makeADAllow()
  
  /** Creates a new instance of ADAllow */
  ...
  //  double longitude
  private int userID;
  private int deploymentEpochID;

  
  // Put in correct detail constructor here.  Use makeADAllow() by filling in all
   ...
   */
  public ADAllow(ResultSet rs) throws SQLException {  //USER: add all data field here
    makeADAllow(rs.getInt("ID"), rs.getString("adAllow"), rs.getInt("userid"), rs.getInt("deploymentepochid")
                            // ,rs.getDouble(longitude)
    );
  }
  
  // Detail Constructor, match set up with makeADAllow(), this argument list should be
  // the same as for the result set builder as both use makeADAllow()
   ...
   */
  public ADAllow(int inID, String loc   //USER: add fields, double lon
          ,int usID, int deID
    ) {
    makeADAllow(inID, loc, usID, deID       //, lon
    );
  }
   ...
   **/
  private void makeADAllow(int inID, String loc    //USER: add fields, double lon
          , int usID, int deID
  ) {
    ...
    userID=usID; deploymentEpochID=deID;
   ...
   */
  public String getADAllow() {return adAllow;}
  ...
  /*  public class EquipCompare implements Comparator {
    public int compare(Object a, Object b) {
      return ((ADAllow) a).getADAllow().compareTo(((ADAllow) b).getADAllow());
    }
    public boolean equals(Object a, Object b) {
      if( ((ADAllow)a).getADAllow().equals( ((ADAllow) b).getADAllow())) return true;
      return false;
    }
//  }*/

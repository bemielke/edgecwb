 ...
 *
 * This Station templace for creating a MySQL database object.  It is not
...
{   // static ArrayList enumName;   // this need to be populated in makeStation()
  ...
  private long telemetryMask;
  private long usgsMask;
  private String url;
  private String datalessURL;
  ...
  public Station(ResultSet rs) throws SQLException {  //USER: add all data field here
    makeStation(rs.getInt("ID"), rs.getString("station")
            ...
            ,rs.getString("fdsnnetworkcode"), rs.getInt("deploymentid"), rs.getString("geology"),
            rs.getString("physical"), rs.getString("maintenance"),
            rs.getLong("instrumentmask"), rs.getLong("telemetrymask"), rs.getLong("usgsmask"),
            rs.getString("url"), rs.getString("datalessURL")
    );
  }
  ...
  public Station(int inID, String loc   //USER: add fields, double lon
          , String fdsn, int deploy, String geol, String phys, String maint,
          long instr, long tele, long usgs, String u, String du
    ) {
    makeStation(inID, loc       //, lon
            , fdsn, deploy, geol, phys,maint,
          instr, tele, usgs, u, du
    );
  }
   ...
   **/
  private void makeStation(int inID, String loc    //USER: add fields, double lon
          , String fdsn, int deploy, String geol, String phys, String maint,
          long instr, long tele, long usgs, String u, String du
  ) {
    ...
    FDSNNetworkCode=fdsn; deploymentID=deploy; geology=geol; physical=phys; maintenance=maint;
    instrumentMask=instr; telemetryMask=tele; usgsMask=usgs; url = u; datalessURL=du;
   ...
   *@return the key name */
  @Override
  public String toString() { return station;}
  // getter
  ...
  public String getGeology() {return geology;}
  ...
  public long getTelemetryMask() {return telemetryMask;}
  public long getUSGSMask() {return usgsMask;}
  public String getURL() {return url;}
  public String getDatalessURL() {return datalessURL;}

...
{ /**
  ...
  */
   ...
   */
   ...
   {
      if (Double.isNaN(x))
          return (width < 3) ? pad("?") : pad("NaN"); // try this out - aww
      if (Double.isInfinite(x))
          return (width < 3) ? pad("?") : pad("Inf"); // try this out - aww 2007/09/20
   ...
   */
   ...
   {  if (fmt != 's')
         throw new java.lang.IllegalArgumentException();
      if (precision >= 0) s = s.substring(0, Math.min(precision,s.length()));
      return pad(s);
   }
   ...
   {  String p = "";
    ...
    /*
     * DDG - fixed rounding bug 01/05/2000
     * Before it would turn 1.99 -> "1.0" rathen then "2.0"
     */
...
/*
  static final class Tester {
    public static void main(String[] a) {
      ...
      Format.print(System.out, "bb = |%5.2f|\n", bb);
      Format.print(System.out, "aa = |%5.2f|\n", aa);
      Format.print(System.out, "aa = |%5.1f|\n", aa);
      Format.print(System.out, "aa = |%5.0f|\n", aa);

      aa = 0.05;
      Format.print(System.out, "aa = |%0.1f|\n", aa);
      Format.print(System.out, "aa = |%.2f|\n", aa);

      bb = -117.6846;
      Format.print(System.out, "bb = |%5.4f|\n", bb);
      Format.print(System.out, "bb = |%5.3f|\n", bb);
      Format.print(System.out, "bb = |%5.2f|\n", bb);
      Format.print(System.out, "bb = |%5.1f|\n", bb);
      Format.print(System.out, "bb = |%5.0f|\n", bb);

      double cc = 117.05555;
      Format.print(System.out, "bb = |%2.2f|\n", cc);
      Format.print(System.out, "bb = |%5.4f|\n", cc);   //bb = |117.0555| doesn't round correctly!
      Format.print(System.out, "bb = |%5.3f|\n", cc);
      Format.print(System.out, "bb = |%5.2f|\n", cc);
      Format.print(System.out, "bb = |%5.1f|\n", cc);
      ...
      Format.print(System.out, "s = |%-3s|\n", "Hello");

      Format.print(System.out, "s = |%3s|\n", "Hello");
//      Format.print(System.out, "s = |%3c|\n", "Hello");  // causes error

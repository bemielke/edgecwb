 ...
 * @author D.C. Ketchum
 */
public class NetStationLocationChannelComparator implements Comparator {

  /**
   * Creates a new instance of StationComponentComparator
   */
  public NetStationLocationChannelComparator() {
  }
  ...
  public int compare(Object o1, Object o2) {
    ...
    return (s1.substring(0, 7) + s1.substring(10) + s1.substring(7, 10)).compareTo(s2.substring(0, 7) + s2.substring(10) + s2.substring(7, 10));
  }

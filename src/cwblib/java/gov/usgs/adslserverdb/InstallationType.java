 ...
 *
 * This InstallationType templace for creating a MySQL database object.  It is not
 * really needed by the InstallationTypePanel which uses the DBObject system for
 ...
 *     of data.  
 *<br>
 * The InstallationType should be replaced with capitalized version (class name) for the
 * file.  installationType should be replaced with the lower case version (for variables).
 *
 * Both the constructors use the "makeInstallationType(list of data args) to set the
 ...
 * @author  D.C. Ketchum
 */
public class InstallationType     //implements Comparator
{   // static ArrayList enumName;   // this need to be populated in makeInstallationType()
  
  /** Creates a new instance of InstallationType */
  int ID;                   // This is the MySQL ID (should alwas be named "ID"
  String installationType;             // This is the main key which should have same name
  ...
  // Put in correct detail constructor here.  Use makeInstallationType() by filling in all
   ...
   */
  public InstallationType(ResultSet rs) throws SQLException {  //USER: add all data field here
    makeInstallationType(rs.getInt("ID"), rs.getString("installationType"), rs.getString("description")
                            // ,rs.getDouble(longitude)
    );
  }
  
  // Detail Constructor, match set up with makeInstallationType(), this argument list should be
  // the same as for the result set builder as both use makeInstallationType()
   ...
   */
  public InstallationType(int inID, String loc , String desc  //USER: add fields, double lon
    ) {
    makeInstallationType(inID, loc , desc      //, lon
    );
  }
   ...
   **/
  private void makeInstallationType(int inID, String loc    //USER: add fields, double lon
          ,String desc
  ) {
    ID = inID;  installationType=loc;     // longitude = lon
   ...
   *@return the key name */
  public String toString2() { return installationType;}
  /** Return the key name as the string.
   *@return the key name */
  @Override
  public String toString() { return installationType;}
  // getter
  ...
  /*  public class EquipCompare implements Comparator {
    public int compare(Object a, Object b) {
      return ((InstallationType) a).getInstallationType().compareTo(((InstallationType) b).getInstallationType());
    }
    public boolean equals(Object a, Object b) {
      if( ((InstallationType)a).getInstallationType().equals( ((InstallationType) b).getInstallationType())) return true;
      return false;
    }
//  }*/

...
/*_############################################################################
  ...
  _##########################################################################
   ...
   Adapted to Alarm System by d.c. ketchum Dec 2007
 */
...
//    BasicConfigurator.configure();
  ...
  private void init() throws UnknownHostException, IOException {
    ...
    snmp.listen();
    Util.prta("MultiThreadedTrapRecever is set up at "+listenAddress);
  }
  ...
  public void processPdu(CommandResponderEvent event) {
    ...
    Util.prta("pdu="+event.getPDU().toString());
    Util.prta("event="+event.toString());
    n++;
    if ((n % 100 == 1)) {

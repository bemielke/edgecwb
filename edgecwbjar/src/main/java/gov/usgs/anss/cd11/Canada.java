...
//public static StringBuilder getSB() {return sb;}
	 ...
	 * @param m is the number of samples (must be divisible by 4) - hydroacoustic does 10 samples of this is LEV and LEA so allow that
...
public static int canada_uncompress(byte [] b, int [] y, int n, int m, int v0) throws CanadaException
{
  ...
  //sb.append("\nUcmp "+first+","); for(i=0; i<m; i++) sb.append(y[i]+",");sb.append("->");
	...
	if (m % 4 != 0 && m != 10) throw new CanadaException("Number of samples is not a multiple of 4="+m);

 ...
 *
 * Created on 17 February 2005, 17:12
 */


/*
 *
 *  !!! NOTE: this class is meant to override java.io.PushbackInputStream (version 1.36, 02/19/04)
 *  in Java version 1.5 which has an apparent bug:
 *
 *    public synchronized void reset() throws IOException {
 *       throw new IOException("mark/reset not supported");
 *   }
 *
 *  should not throw an exception!  This does not allow extended classes such as BufferedInputStream to implement reset()
 *
 *
 */

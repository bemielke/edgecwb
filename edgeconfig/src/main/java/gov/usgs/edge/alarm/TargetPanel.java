 ...
 * JComboBox variable this variable is called "target" in the initial form
 * The table name and key name should match and start lower case (target).
 * The Class here will be that same name but with upper case at beginning(Target).
 * <br> 1)  Rename the location JComboBox to the "key" (target) value.  This should start Lower
 *      case.
 * <br>  2)  The table name should match this key name and be all lower case.
 * <br>  3)  Change all Target to ClassName of underlying data (case sensitive!)
 * <br>  4)  Change all target key value (the JComboBox above)
 ...
 * <br> 10) TargetPanel() constructor - good place to change backgrounds using UC.Look() any
 ...
 * @author D.C. Ketchum
 */
public final class TargetPanel extends javax.swing.JPanel {
  ...
  private boolean chkForm() {
   ...
   Util.prt("chkForm Target");
   if(aliasFlag.isSelected()) aliasFlagInt=1;
   else aliasFlagInt= 0;
  ...
  private void clearScreen() {
    ...
    addUpdate.setText("Enter a Target");
    
    //USER: Clear all fields for this form, this sets "defaults" for new screen
    // description.setText("");
    aliasFlag.setSelected(false);
    email.setText("");
    process.setText("");
    pagerText.setText("");
    fallbackProcess.setText("");
    fallbackText.setText("");
   
  }
 
  
  private Target newOne() {
      
    return new Target(0, ((String) target.getSelectedItem()).toUpperCase(), //, more
      0,  // aliasFlag
      "", // email
      "", // process
      "", // pagerText
  ...
  private void oldOne(String p) throws SQLException {
    ...
    if(obj.isNew()) {
      ...
      //      target.setText(obj.getString("Target"));
      // Example : description.setText(obj.getString("description"));
      if(obj.getInt("aliasFlag")>0){
        aliasFlag.setSelected(true);
        email.setEnabled(false);
        process.setEnabled(false);
        pagerText.setEnabled(false);        
        email.setText("");
        process.setText("");
        pagerText.setText("");
      }
        ...
        pagerText.setEnabled(true);
        email.setText(obj.getString("email"));
        process.setText(obj.getString("process"));
        pagerText.setText(obj.getString("pagerText"));
      }
      fallbackProcess.setText(obj.getString("fallbackProcess"));
      fallbackText.setText(obj.getString("fallbackText"));
  ...
  private void initComponents() {
    ...
    fallbackProcess = new javax.swing.JTextField();
    jLabel3 = new javax.swing.JLabel();
    jLabel4 = new javax.swing.JLabel();
    jLabel5 = new javax.swing.JLabel();
    jLabel6 = new javax.swing.JLabel();
    jLabel7 = new javax.swing.JLabel();
    fallbackText = new javax.swing.JTextField();
    jLabel1 = new javax.swing.JLabel();
    aliasFlag = new javax.swing.JRadioButton();
    ...
    process.setText(" ");
    process.setPreferredSize(new java.awt.Dimension(300, 20));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 1;
    gridBagConstraints.gridy = 4;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    add(process, gridBagConstraints);

    pagerText.setText(" ");
    pagerText.setPreferredSize(new java.awt.Dimension(300, 20));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 1;
    gridBagConstraints.gridy = 5;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    add(pagerText, gridBagConstraints);

    fallbackProcess.setText(" ");
    fallbackProcess.setPreferredSize(new java.awt.Dimension(300, 20));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 1;
    gridBagConstraints.gridy = 6;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    add(fallbackProcess, gridBagConstraints);
    ...
    jLabel6.setText("Fallback Process : ");
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 0;
    gridBagConstraints.gridy = 6;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
    ...
    fallbackText.setText(" ");
    fallbackText.setPreferredSize(new java.awt.Dimension(300, 20));
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.gridx = 1;
    gridBagConstraints.gridy = 7;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    add(fallbackText, gridBagConstraints);
    ...
    aliasFlag.setText(" Is Target an Alias?");
    aliasFlag.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
    aliasFlag.setMargin(new java.awt.Insets(0, 0, 0, 0));
    aliasFlag.setMaximumSize(new java.awt.Dimension(129, 20));
    aliasFlag.setMinimumSize(new java.awt.Dimension(129, 20));
    aliasFlag.setPreferredSize(new java.awt.Dimension(129, 20));
    aliasFlag.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        aliasFlagActionPerformed(evt);
      }
    });
    ...
    gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
    add(aliasFlag, gridBagConstraints);

  }// </editor-fold>//GEN-END:initComponents

  private void aliasFlagActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aliasFlagActionPerformed
// TODO add your handling code here:
    if (aliasFlag.isSelected()){
      email.setEnabled(false);
      process.setEnabled(false);
      pagerText.setEnabled(false);
    }
  ...
  }//GEN-LAST:event_aliasFlagActionPerformed
  ...
  private void addUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addUpdateActionPerformed
    ...
    if(chkForm()) return;
    try {
      String p = target.getSelectedItem().toString();
      ...
      obj.setString("target",p);
      
      // USER : Set all of the fields in data base.  obj.setInt("thefield", ivalue);
      obj.setInt("aliasFlag",aliasFlagInt);
      obj.setString("email",email.getText());
      obj.setString("process",process.getText());
      obj.setString("pagerText",pagerText.getText());
      obj.setString("fallbackProcess",fallbackProcess.getText());
      obj.setString("fallbackText",fallbackText.getText());
      
      
      // Do not change
      obj.updateRecord();
      Target.targets=null;       // force reload of combo box
      getJComboBox(target);
      clearScreen();
      target.setSelectedIndex(-1);
    }  catch  (SQLException  E)
    { Util.SQLErrorPrint(E,"target: update failed partno="+target.getSelectedItem());
  ...
  private javax.swing.JRadioButton aliasFlag;
  private javax.swing.JTextField email;
  private javax.swing.JTextField error;
  private javax.swing.JTextField fallbackProcess;
  private javax.swing.JTextField fallbackText;
  ...
  public TargetPanel() {
    initiating=true;
    initComponents();
    getJComboBox(target);                // set up the key JComboBox
    target.setSelectedIndex(-1);    // Set selected type
 ...
 public static JComboBox getJComboBox() { JComboBox b = new JComboBox(); getJComboBox(b); return b;}
  ...
  public static void getJComboBox(JComboBox b) {
    b.removeAllItems();
    makeTargets();
    for (int i=0; i< Target.targets.size(); i++) {
      b.addItem( Target.targets.get(i));
    }
  ...
  public static void setJComboBoxToID(JComboBox b, int ID) {
    ...
    //Util.prt("TargetPanel.setJComboBoxToID id="+ID);
    for(int i=0; i<b.getItemCount(); i++) 
      if(((Target) b.getItemAt(i)).getID() == ID) {
          b.setSelectedIndex(i);
          //Util.prt("TargetPanel.setJComboBoxToID id="+ID+" found at "+i);
      }
  }  
  ...
  public static int getJComboBoxIndex(int ID) {
    if(Target.targets == null) makeTargets();
    for(int i=0; i<Target.targets.size(); i++) if( ID == Target.targets.get(i).getID()) return i;
    return -1;
  }
  ...
  public static void reload() {
    ...
    /* return a ArrayList with all of the Target
   * @return The ArrayList with the target
   */
  public static ArrayList<Target> getTargetArrayList() {
    if(Target.targets == null) makeTargets();
    return Target.targets;
  }
  /** Get the item corresponding to database ID
   *@param ID the database Row ID
   *@return The Target row with this ID
   */
  public static Target getItemWithID(int ID) {
    if(Target.targets == null) makeTargets();
    int i=getJComboBoxIndex(ID);
    if(i >= 0) return Target.targets.get(i);
    else return null;
  }
  
  // This routine should only need tweeking if key field is not same as table name
  private static void makeTargets() {
    Target.makeTargets();
  ...
  private void find() {
    ...
    if(target.getSelectedIndex() == -1) {
      if(target.getSelectedItem() == null) return;
      l = newOne();
    } 
    else {
      l = (Target) target.getSelectedItem();
    }
      
    if(l == null) return;
    String p = l.getTarget();
    if(p == null) return;
    if(p.equals("")) {
      addUpdate.setEnabled(false);
      addUpdate.setText("Enter a Target!");
    ...
    try {
      ...
      if(obj.isNew()) {
          ...
          aliasFlag.setText(obj.getInt("aliasFlag")+"");
          email.setText(obj.getString("email"));
          process.setText(obj.getString("process"));
          pagerText.setText(obj.getString("pagerText"));
          fallbackProcess.setText(obj.getString("fallbackProcess"));
    ...
    { Util.SQLErrorPrint(E,"Target: SQL error getting Target="+p);
    }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      Show.inFrame(new TargetPanel(), UC.XSIZE, UC.YSIZE);
    }

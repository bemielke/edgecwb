 ...
 *
 * This EdgemomSetupInstance templace for creating a database database object.  It is not
 really needed by the EdgemomsetupPanel which uses the DBObject system for
 ...
 *     of data.  
 *<br> 
 The EdgemomSetupInstance should be replaced with capitalized version (class name) for the 
 file.  edgemomsetup should be replaced with the lower case version (for variables).

 Both the constructors use the "makeEdgemomsetup(list of data args) to set the
 ...
 * @author  D.C. Ketchum
 */
public class EdgemomSetupInstance     //implements Comparator
{   // static ArrayList enumName;   // this need to be populated in makeEdgemomsetup()
  
  /** Creates a new instance of EdgemomSetupInstance */
  int ID;                   // This is the database ID (should alwas be named "ID"
  String edgemomsetup;      // THis is the main key which is "role-account-tag"
   ...
   */
  public EdgemomSetupInstance(ResultSet rs) throws SQLException {  //USER: add all data field here
   ...
   *
   */
  public EdgemomSetupInstance(int inID, String inmom, String intag,   //USER: add fields, double lon
          int inroleID,
          String acct,
          int inpriority,
          int inedgethreadID,
  ...
  private void makeEdgemomsetup(int inID, String inmom, String intag,
    ...
    ID = inID; edgemomsetup = inmom; tag=intag;     // longitude = lon
  ...
  public String toString3() {
    String x,r;
    if (roleID==0) r = "NoRole";
    else r = RoleInstancePanel.getRoleWithID(roleID).toString();
    x = r.trim()+"-"+account+"-";
    x += getCommandLine();
  ...
  public String getEdgemomsetup() {return edgemomsetup ;}
  public int getRoleID() {return roleID ;}
  public RoleInstance getRole() {return RoleInstancePanel.getRoleWithID(roleID);}
  public String getAccount() {return account;}
  public int getPriority() {return priority ;}
  public int getEdgethreadID() {return edgethreadID;}
  public String getEdgethreadName() {return EdgethreadPanel.getEdgethreadWithID(edgethreadID).getEdgethread();}
  public String getArgs() { return args ;}
  public String getLogfile() {return logfile ;}
  public String getComment() { if(comment.length() == 0) return "#"; else return (comment.charAt(0) != '#'? "#":"")+comment;}
  ...
  /*  public class EquipCompare implements Comparator {
    public int compare(Object a, Object b) {
      return ((EdgemomSetupInstance) a).getEdgemomsetup().compareTo(((EdgemomSetupInstance) b).getEdgemomsetup());
    }
    public boolean equals(Object a, Object b) {
      if( ((EdgemomSetupInstance)a).getEdgemomsetup().equals( ((EdgemomSetupInstance) b).getEdgemomsetup())) return true;
      return false;
    }
//  }*/
